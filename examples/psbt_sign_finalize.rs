...
use bellscoin::sighash::SighashCache;
use bellscoin::PrivateKey;
use miniscript::bellscoin::consensus::encode::deserialize;
use miniscript::bellscoin::hashes::hex::FromHex;
use miniscript::bellscoin::psbt::PartiallySignedTransaction as Psbt;
use miniscript::bellscoin::{
...
fn main() {
    ...
    //let bridge_descriptor = Descriptor::<bellscoin::PublicKey>::from_str(&s).expect("parse descriptor string");
    ...
    let spend_tx = Transaction {
        version: 2,
        lock_time: bellscoin::absolute::LockTime::from_consensus(5000),
        input: vec![],
        output: vec![],
    };
    ...
    let hash_ty = bellscoin::sighash::EcdsaSighashType::All;
    ...
    println!("{}", bellscoin::consensus::encode::serialize_hex(&tx));
}
