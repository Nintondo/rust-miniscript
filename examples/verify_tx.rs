...
use bellscoin::consensus::Decodable;
use bellscoin::secp256k1::{self, Secp256k1};
use bellscoin::{absolute, sighash, Sequence};
...
fn main() {
    ...
    let _ = miniscript::Descriptor::<bellscoin::PublicKey>::from_str(&desc_string)
    ...
    let prevouts = sighash::Prevouts::All::<bellscoin::TxOut>(&[]);
    ...
    let iter = interpreter.iter_custom(Box::new(|key_sig: &KeySigPair| {
        ...
        ecdsa_sig.hash_ty == bellscoin::sighash::EcdsaSighashType::All
            && secp
...
fn hard_coded_transaction() -> bellscoin::Transaction {
    ...
    bellscoin::Transaction::consensus_decode(&mut &tx_bytes[..]).expect("decode transaction")
}

fn hard_coded_script_pubkey() -> bellscoin::ScriptBuf {
    bellscoin::ScriptBuf::from(vec![
