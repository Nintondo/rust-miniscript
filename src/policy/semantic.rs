...
impl<Pk: MiniscriptKey> Policy<Pk> {
    ...
    ///
    /// ```
    /// use miniscript::{bellscoin::{hashes::hash160, PublicKey}, policy::semantic::Policy, Translator};
    ...
    /// pk_map.insert(String::from("alice_pk"), bellscoin::PublicKey::from_str(alice_pk).unwrap());
    /// pk_map.insert(String::from("bob_pk"), bellscoin::PublicKey::from_str(bob_pk).unwrap());
