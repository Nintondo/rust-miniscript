...
/// Translate from a String MiniscriptKey type to bellscoin::PublicKey
...
pub struct StrKeyTranslator {
    pub pk_map: HashMap<String, bellscoin::PublicKey>,
...
impl Translator<String, bellscoin::PublicKey, ()> for StrKeyTranslator {
...
/// Same as [`StrKeyTranslator`], but for [`bellscoin::XOnlyPublicKey`]
#[derive(Debug, PartialEq, Eq, Clone)]
...
impl StrKeyTranslator {
    pub fn new() -> Self {
        ...
        let pks: Vec<_> = sks
            .iter()
            .map(|sk| bellscoin::PublicKey::new(secp256k1::PublicKey::from_secret_key(&secp, sk)))
            .collect();
