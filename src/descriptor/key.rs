...
use bellscoin::bip32;
use bellscoin::hash_types::XpubIdentifier;
use bellscoin::hashes::hex::FromHex;
use bellscoin::hashes::{hash160, ripemd160, sha256, Hash, HashEngine};
use bellscoin::key::XOnlyPublicKey;
use bellscoin::secp256k1::{Secp256k1, Signing, Verification};
...
/// A descriptor [`bellscoin::PrivateKey`] with optional origin information.
#[derive(Debug, Eq, PartialEq, Clone)]
pub struct SinglePriv {
    /// Origin information (fingerprint and derivation path).
    pub origin: Option<(bip32::Fingerprint, bip32::DerivationPath)>,
    /// The private key.
    pub key: bellscoin::PrivateKey,
}
        ...
        if key_part.contains("pub") {
            ...
            let key = match key_part.len() {
                ...
                66 | 130 => {
                    ...
                    let key = bellscoin::PublicKey::from_str(key_part).map_err(|_| {
...
impl FromStr for DescriptorSecretKey {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        if key_part.len() <= 52 {
            let sk = bellscoin::PrivateKey::from_str(key_part)
...
impl<K: InnerXKey> DescriptorXKey<K> {
    ...
    /// # use std::str::FromStr;
    /// # fn body() -> Result<(), ()> {
    /// use miniscript::bellscoin::bip32;
    /// use miniscript::descriptor::DescriptorPublicKey;
    ///
    /// let ctx = miniscript::bellscoin::secp256k1::Secp256k1::signing_only();
    ///
...
impl DefiniteDescriptorKey {
    ...
    /// and returns the obtained full [`bellscoin::PublicKey`]. All BIP32 derivations
        ...
        match self.0 {
            ...
            DescriptorPublicKey::XPub(ref xpk) => match xpk.wildcard {
                ...
                Wildcard::None => match xpk.xkey.derive_pub(secp, &xpk.derivation_path.as_ref()) {
                    Ok(xpub) => Ok(bellscoin::PublicKey::new(xpub.public_key)),
